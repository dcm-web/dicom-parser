    ...
    for (let row = 0; row < info.rows; row++) {
        for (let col = 0; col < info.columns; col++) {
            ...
            if (info.samplesPerPixel === 1) {
                ...
                if (info.photometricInterpretation === "MONOCHROME1") {
                ...
                else if (info.photometricInterpretation === "PALETTE COLOR" &&
                    ...
                    const firstInputValueMapped = info.redPaletteColorLookupTableDescriptor[1];
                ...
                else if (info.photometricInterpretation === "YBR_FULL" ||
